package com.webservice.doctor.patientcontroller;
...
import com.webservice.doctor.patientservice.PatientService;
...
public class PatientController {
	...
	public String inPatient() {
		return "In Patient Controller webservice project!!! ";
	}
